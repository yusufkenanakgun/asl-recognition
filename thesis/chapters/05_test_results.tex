...
Both letter classifiers reach near-ceiling
...
The 201-clip test partition is the canonical person-mixed WLASL-100
split (Section~\ref{sec:results-methodology}); the numbers below are
reported on that protocol and the unmeasured signer-independent
generalization band is revisited in
Section~\ref{sec:conclusion-limitations}.
...
the canonical person-mixed protocol shared by all entries.
